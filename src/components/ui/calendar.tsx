  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center", // Ensure center alignment
        caption_label: "text-sm font-medium text-center w-full", // Added text-center and w-full
